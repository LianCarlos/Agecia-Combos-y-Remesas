  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="mb-6 max-w-xs text-sm text-slate-400">
        No hay métodos de pago registrados aún. Agrega el primero para comenzar.
      </p>
          ...
          {methods.map((method) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-brand-green/10 text-sm">
                  💳
                </span>
...
function MethodModal({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={editing ? 'Editar método de pago' : 'Nuevo método de pago'}
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        <label htmlFor="method-name" className="mb-1.5 block text-sm font-medium text-slate-600">
          Nombre
        </label>
        <input
          id="method-name"
          ...
          placeholder="Ej: Zelle, Western Union..."
